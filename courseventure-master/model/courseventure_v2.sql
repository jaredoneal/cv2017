...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2016 at 06:56 PM
...
('Andrew', 'UNC Charlotte', 'adennis9', 'adennis9@uncc.edu', 'a'),
('Anna Thom', 'UNC Charlotte', 'annabanana', 'anna@example.com', '135797531'),
('elijah to', 'UNC Charlotte', 'elijm72712', 'elijah.townsend@odfl.com', 'password1'),
('Ryan Farm', 'UNC Charlotte', 'fatfarmer', 'fatfarmer@fattiesonly.com', 'imfat4ever'),
('Tester 1', 'UNC Charlotte', 'tester1', 'test@test.com', 'test'),
...
INSERT INTO `courses` (`CRN`, `subject`, `course`, `section`, `credits`, `title`, `days`, `startTime`, `endTime`, `capacity`, `location`) VALUES
...
('21255', 'ITIS', '5166', 'UOL', '3', 'Network Based Appl Dvlpmnt', '', 'TBA', 'TBA', '125', 'TBA'),
('21256', 'ITIS', '5250', '91', '3', 'Computer Forensics', 'T', '06:30 pm', '09:15 pm', '15', 'WOODW 125'),
('21257', 'ITIS', '6200', 'UOL', '3', 'Prin Info Security & Privacy', '', 'TBA', 'TBA', '83', 'TBA'),
...
('23114', 'ITIS', '4490', '1', '6', 'Professional Internship', '', 'TBA', 'TBA', '15', 'TBA'),
...
('27661', 'ITIS', '2211', '262', '3', 'Ethical Issues in Personal, Professional, and Public Life: Technology', '', 'TBA', 'TBA', '20', 'TBA'),
...
('27854', 'ITIS', '8200', 'UOL', '3', 'Prin Info Security & Privacy', '', 'TBA', 'TBA', '15', 'TBA'),
...
INSERT INTO `enrollment` (`userName`, `coursestaughtID`, `enrollmentID`, `dateCreated`) VALUES
('elijm72712', 44, 33, '2016-04-29'),
('elijm72712', 31, 34, '2016-04-29'),
('elijm72712', 28, 35, '2016-04-29'),
('fatfarmer', 28, 39, '2016-05-02'),
('tester1', 28, 40, '2016-05-02'),
('testUser', 28, 42, '2016-05-03'),
('adennis9', 28, 43, '2016-05-03');
...
--
ALTER TABLE `coursestaught`
  MODIFY `coursestaughtID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
--
...
ALTER TABLE `enrollment`
  ...
  ADD CONSTRAINT `FK_coursestaught` FOREIGN KEY (`enrollmentID`) REFERENCES `coursestaught` (`coursestaughtID`);
